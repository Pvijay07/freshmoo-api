...
CREATE TABLE `subscriptions` (
  ...
  `plan_type` enum('daily','weekly','monthly') DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `number`, `otp`, `role`) VALUES
(1, NULL, NULL, '6303132973', NULL, 'customer');
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`delivery_partner_id`) REFERENCES `users` (`id`);
